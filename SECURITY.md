...
We only provide security fixes for the latest release. Please keep SMEMaster up to date.

## Reporting a Vulnerability

**Please do not report security vulnerabilities through public GitHub issues.**

Instead, please report them via email to **security@smemaster.app** (or by opening a [private security advisory](https://github.com/Zakarialabib/smeMaster/security/advisories/new) on GitHub).
...
SMEMaster is a desktop application. Your emails, tokens, and settings are stored locally in a SQLite database on your machine. There are no SMEMaster-operated backend servers.
...
- **AI API keys**: Stored in the local SQLite settings table. Keys are sent directly to the respective provider (Anthropic, OpenAI, Google) over HTTPS -- never to any SMEMaster server.
...
- Issues in third-party dependencies with no demonstrated impact on SMEMaster

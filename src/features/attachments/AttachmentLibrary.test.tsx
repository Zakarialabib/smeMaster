...
import type { AttachmentWithContext, AttachmentSender } from "@shared/services/db/attachments";
...
vi.mock("@shared/services/db/attachments", () => ({
...
vi.mock("@features/mail/components/AttachmentList", () => ({
...
import { getAttachmentsForAccount, getAttachmentSenders } from "@shared/services/db/attachments";

...
// Mock dependencies
vi.mock("@features/mail/stores/labelStore", () => ({
...
import { archiveThread, trashThread, spamThread, addThreadLabel, removeThreadLabel } from "@features/mail/services/emailActions";
...
describe("MoveToFolderDialog", () => {
  ...
  it("calls addThreadLabel + removeThreadLabel for Gmail label selection", async () => {
    ...
    // removeThreadLabel is called after addThreadLabel resolves  wait for microtasks
    await vi.waitFor(() => {

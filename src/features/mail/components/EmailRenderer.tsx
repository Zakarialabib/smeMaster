...
export function EmailRenderer({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Non-critical â€” images just won't render
      }
    })();
  ...
  // Write content directly into iframe document â€” synchronous, no srcDoc async parsing
  useLayoutEffect(() => {
...
<body>${bodyHtml}</body>
    ...
    // Watch for dynamic changes (images loading, etc.) â€” batched with rAF

...
export const DEMO_PRESETS: DemoPreset[] = [
  {
    ...
    icon: "User",
    tools: { mail: true, crm: true, campaigns: false, calendar: true, ai: false, sync: false },
  },
  {
    id: "small_team",
    label: "Small Team",
    ...
    icon: "Users",
    tools: { mail: true, crm: true, campaigns: true, calendar: true, ai: true, sync: false },
  },
  {
    id: "sales_focused",
    label: "Sales Focused",
    ...
    icon: "Target",
    tools: { mail: true, crm: true, campaigns: true, calendar: false, ai: true, sync: true },
  },
  {
    id: "custom",
    label: "Custom",

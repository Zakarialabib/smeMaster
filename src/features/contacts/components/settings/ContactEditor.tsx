...
import { useContactSegments } from "@features/contacts/hooks/useContactSegments";
...
export function ContactEditor() {
  ...
  const { data: contactSegments = [] } = useContactSegments(primaryAccountId);
      ...
      {tab === "contacts" ? (
        <>
                  ...
                  {editingId === contact.id ? (
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      ...
                      <Button
                        ...
                        className="text-success hover:bg-bg-hover"
                      ...
                      <Button
                        ...
                        className="text-text-tertiary hover:text-text-primary hover:bg-bg-hover"
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          className="text-text-tertiary hover:text-text-primary opacity-0 group-hover:opacity-100"
                          title="Edit name"
          ...
          <p className="text-xs text-text-tertiary">
            ...
            {contactSegments.length > 0 && (
              <> · {contactSegments.filter(s => s.engagement_score > 50).length} high-engagement</>
            )}
          </p>
        </>
      ) : (
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            <Button variant="primary" size="sm" onClick={() => setShowCsvImport(true)}>

      ...
      >
        ...
        <button onClick={handleToggle} className="mt-0.5 shrink-0">
          {task.is_completed ? (
            ...
            <Circle size={16} className={PRIORITY_COLORS[task.priority as TaskPriority]} />
          )}
        </button>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            {task.priority !== "none" && (
              <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${PRIORITY_DOT_COLORS[task.priority as TaskPriority]}`} />
            )}
            <span
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              {contactName && contactId && (
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[0.6875rem] text-text-secondary hover:text-accent transition-colors"
                ...
                >
                  ...
                  <span className="max-w-[100px] truncate">{contactName}</span>
                </button>
              )}
            </div>
          )}

      ...
      {showForm ? (
        <div className="border border-border-primary rounded-md p-3 space-y-3">
          <input
            ...
            placeholder={t('settings.smartFolderNamePlaceholder')}
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                placeholder={t('settings.iconNamePlaceholder')}
              ...
              <p className="text-[0.625rem] text-text-tertiary mt-0.5">
                {t('settings.iconNameHint')}
              </p>
            </div>
            <div className="flex-1">
              <label className="text-xs text-text-secondary block mb-1">
                {t('settings.colorOptional')}
              </label>
              <input
                type="text"
                value={color}

...
import { LayoutPanelLeft, LayoutPanelTop, PanelRightClose, Maximize2, Type, Layers, Columns3, Trash2, AlertTriangle, Palette, Globe, Shield, SlidersVertical } from "lucide-react";
...
interface SubTab {
  id: "appearance" | "language" | "privacy" | "advanced";
  labelKey: string;
  icon: typeof Palette;
}

const SUB_TABS: SubTab[] = [
  { id: "appearance", labelKey: "settings.tabs.general", icon: Palette },
  { id: "language", labelKey: "Language & Region", icon: Globe },
  { id: "privacy", labelKey: "settings.privacyAndSecurity", icon: Shield },
  { id: "advanced", labelKey: "Data Management", icon: SlidersVertical },
];
...
export default function GeneralTab() {
  ...
  const [activeSubTab, setActiveSubTab] = useState<"appearance" | "language" | "privacy" | "advanced">("appearance");

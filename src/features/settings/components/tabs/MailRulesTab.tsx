...
import { Tags, Filter, Layers, Zap, GitBranch } from "lucide-react";
...
interface SubTab {
  id: "labels" | "filters" | "smart" | "actions";
  labelKey: string;
  icon: typeof Tags;
}

const SUB_TABS: SubTab[] = [
  { id: "labels", labelKey: "nav.labels", icon: Tags },
  { id: "filters", labelKey: "settings.filters", icon: Filter },
  { id: "smart", labelKey: "Smart", icon: Layers },
  { id: "actions", labelKey: "Actions", icon: Zap },
];

export default function MailRulesTab() {
  const { t } = useTranslation();
  const [activeSubTab, setActiveSubTab] = useState<"labels" | "filters" | "smart" | "actions">("labels");

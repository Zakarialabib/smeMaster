...
export function SmartLabelEditor() {
  ...
  }, [criteriaFrom, criteriaTo, criteriaSubject, criteriaBody, criteriaHasAttachment]);
  ...
  const handleSave = useCallback(async () => {
    ...
    resetForm();
    await loadRules();
  }, [activeAccountId, labelId, aiDescription, editingId, resetForm, loadRules, buildCriteria]);

...
export default function BiometricLockScreen({ error, onUnlock, isLoading }: Props) {
  const { t } = useTranslation();

  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-bg-primary px-6">
      <svg
        className="w-48 mb-8"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 431 97.455"
        fill="none"
      >
        <g>
          <path
            d="M107.905 65.616c-2.3 1-4.4 1.6-6.8 2.4l-2.6 4.8c-7.6.7-11.2-10.9-13.6-16.5L74.105 30.916c-1.6-3.8-4.3-10.4-6.3-13.9-1.3-2.2-2.8-4.3-4.6-6.1-10.3-10.6-21.5-8.8-35.1-8.8-9.4.1-18.7.1-28.1 0C-.195 13.916 5.505 22.516 15.305 28.516c.4 2.1.9 4.6 1.6 6.6 2.8.1 6.7 1.7 8.9.8l.2-.3c-.7-1.5-1-2.5-1.5-4.1 16.1 1.6 21.5-2.3 36.6 5.8 4.8 3.6 7.9 6.2 11.2 11.4 2.2 4.3 4.2 8.9 6.1 13.4 3.3 7.7 6.3 15.4 15 18.3.3.1.6.2 1 .3 5.6.1 6.6-.3 11.1-3.6 0 0 0 0 0 0 1.1-1.7 5.4-9.7 6.1-11.5.8-1.3 1.3-2.2 1.9-3.6-1.7.1-3.4 2.5-5.6 3.4zM51.305 24.816c-2.8-.4-4.8-.7-7.6-.9-14.5-.6-26.6 2.7-33.8-13.5h22l.1-.001c4.4 0 11.6-.4 15.7.6 3.4.9 6.6 2.6 9.1 5.1 3.4 3.4 6.1 9.1 7.6 13.7-5.5-2.8-7.2-3.5-13.2-5z"
            fill="#818CF8"
          />
          <path
            d="M16.805 35.116c2.8.1 6.7 1.7 8.9.8l.2-.3c2.7 4.7 6.1 7.9 11.5 9.4 2.7.7 5.4.6 8.2 1 8.2 1.1 13.5 6 16.9 13.4 3.8 8 6.7 17.4 11.1 25 2 3.4 6.8 5.6 10.4 4.9 4.5-.4 8.9-4.3 10.3-8.6 5.6.1 6.6-.3 11.1-3.6-3.6 7.5-7.2 15.8-15.4 19-3.8 1.5-7.9 1.7-11.8.8-10-2.3-13.2-10.3-16.7-18.6l-5.2-12.3c-1.5-3.5-2.7-7-5.7-9.4-4-3.2-8.1-2.6-12.8-3.3-2.3-.4-4.5-1-6.6-2-7.6-3.3-11.5-8.9-14.4-16.3z"
            fill="#1C2549"
          />
          <path
            d="M43.805 23.916c2.8.2 4.8.4 7.6.9 6 1.5 7.7 2.2 13.2 5 1.3 2.1 7.4 16.4 7.8 19-.3.3-3.3-5.2-11.2-11.4-3-5.5-6.1-8.4-11.5-11.4-1.8-.6-4-1.2-5.8-2.1z"
            fill="#1C2549"
          />
          <path
            d="M15.305 28.516c1 .4 9.5 3.3 9.2 3.1.5 1.6.8 2.6 1.5 4.1l-.2.3c-2.2.9-6.1-.7-8.9-.8-.6-2-1.1-4.5-1.6-6.6z"
            fill="#10182C"
          />
          <path
            d="M86.905 48.516c2.4-4.8 5.2-9.7 7.7-14.4 8.3-16 14.9-32.5 36.2-32 4.5.1 9.8 0 14.3 0-1 2.4-3.1 6.1-4.4 8.5l-10.7 20.4-10.6 20c-1.7 3.2-4.1 8.2-6 11.2-1.7.1-3.4 2.5-5.6 3.4-2.3 1-4.4 1.6-6.8 2.4 10-19.1 20.7-38.5 30.5-57.7-16.4-.4-19.9 8.8-26.6 21.4-4.6 8.7-9.2 17.9-14 26.4l-4.1-9.7z"
            fill="#1C2549"
          />
        </g>
        <g fill="#e2e8f0" stroke="#e2e8f0" strokeWidth="4" strokeLinejoin="round">
      ...
      <button
        onClick={onUnlock}
        disabled={isLoading}
        className="relative overflow-hidden rounded-xl bg-indigo-500 px-8 py-3 text-sm font-medium text-white shadow-lg shadow-indigo-500/30 transition-all hover:bg-indigo-400 active:scale-95 disabled:opacity-50"
      >
        {isLoading ? (

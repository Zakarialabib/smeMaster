...
vi.mock("@features/mail/db/writingStyleProfiles", () => ({
...
const { getAiCache, setAiCache, deleteAiCache } = await import("@features/mail/db/aiCache");
const { getWritingStyleProfile, upsertWritingStyleProfile, deleteWritingStyleProfile } =
  await import("@features/mail/db/writingStyleProfiles");
const { getRecentSentMessages } = await import("@shared/services/db/messages");

...
export const POLISH_REPLY_PROMPT = `You are a professional email writing assistant. Rewrite the following draft email to be more professional, clear, and effective. Preserve the original intent and key information. Fix any grammar or spelling issues. Keep the same approximate length.

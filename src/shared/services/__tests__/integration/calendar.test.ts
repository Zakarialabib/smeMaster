...
describe("Integration: Calendar", () => {
  ...
  describe("Test #10: Calendar event create + sync", () => {
    it("creates a calendar event via Google Calendar API and persists it", async () => {
      ...
      const { GoogleCalendarProvider } = await import("@features/calendar/services/googleCalendarProvider");
      ...
      const { upsertCalendarEvent } = await import("@features/calendar/db/calendarEvents");

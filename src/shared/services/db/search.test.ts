...
describe("unifiedSearch", () => {
  ...
  it("returns results sorted by rank (messages first)", async () => {
    mockExecuteSearchQuery
      .mockResolvedValueOnce([
        { type: "message", id: "m1", title: "Subject A", snippet: "snippet", date: 2000, rank: 1, account_id: "acc-1", metadata: "{}" },
        { type: "message", id: "m2", title: "Subject B", snippet: "snippet", date: 1000, rank: 2, account_id: "acc-1", metadata: "{}" },
      ])
      .mockResolvedValueOnce([])
      .mockResolvedValueOnce([])
      .mockResolvedValueOnce([]);
  ...
  it("limits results to specified limit", async () => {
    ...
    mockExecuteSearchQuery.mockResolvedValueOnce(manyMessages)
      .mockResolvedValueOnce([])
      .mockResolvedValueOnce([])
      .mockResolvedValueOnce([]);

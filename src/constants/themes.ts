...
export const COLOR_THEMES: ColorTheme[] = [
  ...
  },
  {
    ...
    light: {
      ...
      accentHover: "#0842A0",
      accentLight: "#D3E3FD",
      bgSelected: "rgba(11, 87, 208, 0.12)",
      sidebarActive: "#0B57D0",
    },
    dark: {
      accent: "#8AB4F8",
      accentHover: "#AECBFA",
      accentLight: "rgba(138, 180, 248, 0.15)",
      bgSelected: "rgba(99, 133, 243, 0.18)",
      sidebarActive: "#8AB4F8",
    },
  },
];

export const DEFAULT_COLOR_THEME: ColorThemeId = "frost";

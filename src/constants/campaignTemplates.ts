/**
 * @deprecated Use DB-backed campaign presets (DbTemplate from @features/mail/db/templates) instead.
 * Remove once all UIs use campaignTemplateCatalog.
 */
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:100%;background:#ffffff;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="background:linear-gradient(135deg,#6366f1,#8b5cf6);padding:28px 32px;">
            <h1 style="margin:0;font-size:22px;color:#ffffff;font-weight:700;">SMEMaster</h1>
          </td>
        </tr>
        <tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                <td align="center" style="font-size:12px;color:#a1a1aa;">
                  <p style="margin:0 0 4px;">© 2025 SMEMaster. All rights reserved.</p>
          ...
          <td style="background:#2563eb;padding:20px 32px;">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                ...
                <td align="right" style="font-size:20px;color:#ffffff;font-weight:700;">SMEMaster</td>
              </tr>
            </table>
          </td>
        </tr>
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:100%;background:#ffffff;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="background:#27272a;padding:24px 32px;">
            <h1 style="margin:0;font-size:18px;color:#ffffff;font-weight:600;">SMEMaster</h1>
          </td>
        </tr>
        <tr>
          <td style="padding:32px 32px 0;">
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:100%;background:#ffffff;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="background:#18181b;padding:24px 32px;">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                <td style="font-size:20px;color:#ffffff;font-weight:700;">SMEMaster</td>

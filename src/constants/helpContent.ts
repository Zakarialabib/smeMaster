...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: "local-rag",
        icon: Database,
        title: "Local AI Knowledge Base (RAG)",
        summary: "Index your email data locally for semantic search without sending data to the cloud.",
        description:
          "The Local RAG (Retrieval-Augmented Generation) system indexes your email content into a local vector database (LanceDB) so you can ask semantic questions and get context-augmented answers — all on your device. Embeddings are generated either locally via the built-in BGE-small model (candle engine) or through your AI provider's embeddings API (LM Studio, Ollama, OpenAI-compatible). The AI Assistant panel on the compose inbox surfaces relevant knowledge from your indexed data when drafting replies or summarizing threads. Toggle RAG on or off in Settings > AI > Local RAG.",
        tips: [
          { text: "Enable RAG in Settings > AI > Local RAG." },
          { text: "Choose between local BGE-small model or provider embeddings (LM Studio, Ollama, OpenAI)." },
          { text: "Download the embedding model, index your data, then ask questions on the AI Assistant page." },
          { text: "Your data never leaves your device when using the local model." },
          { text: "The AI Assistant panel enriches drafts and summaries with relevant indexed content." },
          { text: "Re-index if you want to refresh the vector database after significant email changes." },
        ],
        relatedSettingsTab: "ai",
      },
    ],
    ...
    cards: [
      {
        ...
        tips: [
          ...
          { text: "Uses your OS's native notification system (Windows, macOS)." },
        ],
    ...
    cards: [
      {
        ...
        summary: "Secure file storage and management integrated with email.",
        description:
          "The Vault is a built-in file manager for storing and organizing attachments and documents. Files are stored locally in an encrypted vault per account. Browse files in grid or list view, search by name or type, preview images and PDFs, and organize with folders. Drag and drop files to upload, or save attachments directly from emails.",
        tips: [
          { text: "Open Vault from the sidebar (folder icon)." },
          { text: "Files are encrypted per account using AES-256-GCM." },
          { text: "Drag and drop to upload, or save from email attachments." },
          { text: "Create folders to organize files." },
          { text: "Switch between grid and list views." },
          { text: "Preview images and PDFs inline." },
        ],
        relatedSettingsTab: "general",
      },
      {
        id: "vault-search",
        icon: Search,
        title: "Vault search & filtering",
        summary: "Find files instantly with powerful search and filters.",
        description:
          "Search files by name, filter by file type (images, PDFs, documents, spreadsheets, archives), sender, date range, or file size. The search runs against the local database for instant results.",
        tips: [
          { text: "Search by filename, subject, or sender name." },
          { text: "Filter by type, sender, date range, or file size." },
          { text: "Results update instantly as you type." },
      ...
      },
      {
        ...
        summary: "Select multiple files for batch actions.",
        description:
          "Select multiple files using checkboxes to perform bulk operations: delete, move to folder, or download. A bulk action bar appears at the bottom when files are selected.",
        tips: [
          { text: "Click checkboxes to select multiple files." },
          { text: "Bulk actions: delete, move, download." },
          { text: "Shift+click to select a range of files." },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        summary: "Create, send, and track email campaigns with mail merge.",
        description:
        ...
        tips: [
          ...
          { text: "A/B test subject lines and content." },
          { text: "Schedule campaigns for later or send immediately." },
        ],
        relatedSettingsTab: "composing",
      },
      {
        ...
        summary: "Track opens, clicks, bounces, and engagement.",
        description:
      ...
      },
      {
        ...
        summary: "Reusable campaign designs with merge fields.",
        description:
          "Save campaign designs as templates for reuse. Templates support mail merge variables and can be shared across campaigns. Create a library of branded templates for newsletters, announcements, promotions, and more.",
        tips: [
          { text: "Save any campaign as a template from the review step." },
          { text: "Templates appear in the template picker for new campaigns." },
          { text: "Supports all mail merge variables." },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        summary: "Automate email actions with trigger-based rules.",
        description:
        ...
        tips: [
          ...
          { text: "Multiple matching rules merge their actions." },
          { text: "Test rules against existing emails before enabling." },
        ],
        relatedSettingsTab: "mail-rules",
      },
      {
        ...
        summary: "Build multi-step workflows with branching logic.",
        description:
          "The workflow editor lets you create complex multi-step automations with a visual canvas. Add steps for conditions, actions, delays, and branches. Connect steps to define flow. Workflows can wait for replies, check conditions over time, and branch based on outcomes.",
        tips: [
          { text: "Drag steps from the palette onto the canvas." },
          { text: "Connect steps to define execution flow." },
          { text: "Step types: Condition, Action, Delay, Branch, Webhook." },
          { text: "Test workflows with sample data before activating." },
        ],
      },
    ],
  },
  {
    ...
    cards: [
      {
        id: "deliverability-overview",
        icon: ShieldAlert,
        title: "Deliverability dashboard",
        summary: "Monitor email health and reputation across domains.",
        description:
          "Track SPF, DKIM, DMARC alignment, blacklist status, and sender reputation for your sending domains. The dashboard aggregates data from multiple sources and provides actionable insights to improve inbox placement.",
        tips: [
          { text: "Open Deliverability from the sidebar." },
          { text: "Monitors SPF, DKIM, DMARC for each sending domain." },
          { text: "Checks 4 major blacklists (Spamhaus, Barracuda, SURBL, SpamCop)." },
          { text: "Reputation scoring with trend analysis (improving/declining/stable)." },
        ],
        relatedSettingsTab: "general",
      },
      {
        ...
        summary: "Automatic blacklist checks with alerts.",
        description:
          "Continuous monitoring of your sending IPs and domains against major DNSBLs. Get notified immediately if listed. One-click delist request generation with tracking.",
        tips: [
          { text: "Checks run every 6 hours automatically." },
          { text: "Get desktop notifications on new listings." },
          { text: "Generate delist URLs with pre-filled forms." },
          { text: "Track delist submission status." },
        ],
      },
      {
        id: "bulk-health",
        icon: Activity,
        title: "Bulk health checks",
        summary: "Scan multiple domains at once.",
        description:
          "Run bulk health checks across all your sending domains. Aggregated SPF/DKIM/DMARC/blacklist scan with pass/fail summary. Export results for compliance reporting.",
        tips: [
          { text: "Click 'Run Bulk Check' to scan all domains." },
          { text: "Results show pass/fail for each check per domain." },
          { text: "Export as CSV for compliance records." },
        ],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        summary: "Full-featured email on Android and iOS.",
        description:
          "The mobile app provides a native experience with bottom tab navigation (Mail, Contacts, Settings), pull-to-refresh, swipe gestures for quick actions, and adaptive layouts that work on any screen size. All core features work offline with background sync.",
        tips: [
          { text: "Bottom tabs: Mail, Contacts, Settings." },
          { text: "Swipe left/right on emails for archive, delete, snooze." },
          { text: "Pull to refresh in any list." },
          { text: "Offline mode: compose, archive, star — syncs when online." },
          { text: "Biometric lock (fingerprint/Face ID) for app access." },
        ],
      },
      {
        id: "mobile-gestures",
        ...
        summary: "Swipe actions for fast email triage.",
        description:
          "Customizable swipe gestures on email lists: swipe right to archive, swipe left for more actions (delete, snooze, star, label). Works in all list views (inbox, labels, search results). Multi-select with long press.",
        tips: [
          { text: "Customize swipe actions in Settings > Mobile." },
          { text: "Default: swipe right = archive, swipe left = actions menu." },
          { text: "Long press to enter multi-select mode." },
        ],
      },
      {
        id: "mobile-pairing",
        ...
        summary: "Pair mobile with desktop for seamless sync.",
        description:
          "Pair your mobile device with the desktop app using a QR code. Once paired, accounts, settings, and sync state are shared. Changes on one device reflect on the other instantly.",
        tips: [
          { text: "Go to Settings > Device Pairing on desktop." },
          { text: "Scan QR code with mobile app." },
          { text: "Accounts and settings sync automatically." },
        ],
      },
    ],
  },
...
export const CONTEXTUAL_TIPS: Record<string, ContextualTip> = {
  ...
  "vault-overview": {
    ...
    body: "Secure encrypted file storage with folder organization, search, preview, and multi-account isolation. Access from the sidebar.",
    helpTopic: "vault",
  },
  "workflows": {
    title: "Automation workflows",
    body: "Create multi-step automations with conditions, actions, delays, and branches. Visual canvas editor. Test before activating.",
    helpTopic: "workflows",
  },
  "deliverability": {
    title: "Deliverability monitoring",
    body: "Track SPF/DKIM/DMARC, blacklist status, and sender reputation. Bulk health checks and automated alerts.",
    helpTopic: "deliverability",
  },
  "mobile-overview": {
    title: "Mobile app",
    body: "Native Android/iOS app with bottom tabs, swipe gestures, offline mode, biometric lock, and device pairing via QR code.",
    helpTopic: "mobile",
  },
};
